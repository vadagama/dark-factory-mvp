...
Pre-MVP. MVP-ядро реализовано: CLI-исполнение стадий (US1), SDD-контур (US2), гейты и merge-политика (US3–US4), GitOps-релиз (US5), API и Console (US6), durable-раннер `factory run advance` (ADR-024/025); стек зафиксирован в ADR-002. Впереди — e2e-пилот (T043) и финальная приёмка (T056); прогресс и статусы задач — в `specs/001-dark-factory-mvp/tasks.md`.
...
| `docs/` | Проектная документация: индекс, ADR; `vision-*.md`, `hld.md` создаются ролями |
