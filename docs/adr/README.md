...
| [ADR-028](ADR-028-human-gates-at-design-phase.md) | Human gates at the design phase and machine-only pipeline resolution (уточняет ADR-018 п.1 и ADR-023 п.1/3/4/6) | принято |
